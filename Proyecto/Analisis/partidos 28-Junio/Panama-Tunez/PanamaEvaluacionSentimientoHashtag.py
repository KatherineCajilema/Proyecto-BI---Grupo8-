...
url = 'http://localhost:5984/panama/_design/panama28JuneHashtag/_view/panama28JuneHashtag'
req = urllib2.Request(url)
f = urllib2.urlopen(req)

d = json.loads(f.read())

archivo = open("/home/usrkap/Downloads/ResultadoPanamaHashtag.txt","a") #opens file with name of "test.txt"
cont_positives = 0
cont_negatives = 0
cont_neutrals = 0
cont_total = 0
...
legend()
title('Evaluacion de Sentimientos Tweets Panama Hashtag', bbox={'facecolor':'0.8', 'pad':5})

savefig("tweets_sentiments_panama2.png")
