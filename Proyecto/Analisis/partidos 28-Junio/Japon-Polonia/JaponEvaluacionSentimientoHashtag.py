...
archivo = open("/home/usrkap/Downloads/ResultadoJaponHashtag.txt","a") #opens file with name of "test.txt"
cont_positives = 0
cont_negatives = 0
cont_neutrals = 0
cont_total = 0
...
legend()
title('Evaluacion de Sentimientos Tweets Japon Hashtag', bbox={'facecolor':'0.8', 'pad':5})

savefig("tweets_sentiments_japon2.png")
