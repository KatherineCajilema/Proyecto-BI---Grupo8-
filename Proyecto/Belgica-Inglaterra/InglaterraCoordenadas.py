...
url = 'http://127.0.0.1:5984/inglaterra/_design/inglaterra28JuneCoordenadasOp/_view/inglaterra28JuneCoordenadasOp'
...
for x in d['rows']:
	...
	with open ('CoordenadasInglaterra.txt' , 'w') as outfile:
